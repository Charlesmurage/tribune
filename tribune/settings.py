...
SECRET_KEY='!9hk^&+u5v+6yjfn159mca!2f&_66f-+$_l==ojqj@84+&uhoc'
...
# production
   ...
   DATABASES = {
       'default': dj_database_url.config(
           default='postgres://charles:3094@localhost/tribune'
       )
   }
...
MIDDLEWARE = [
    ...
    'whitehouse.middleware.WhiteNoiseMiddleware',
]
